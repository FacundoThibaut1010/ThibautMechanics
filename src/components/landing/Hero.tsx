...
export const Hero = () => {
  ...
  return (
    <section id="inicio" ref={containerRef} className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden min-h-screen flex items-center">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
        ...
        <h1 className="hero-title text-5xl md:text-7xl font-extrabold tracking-tight mb-6 text-slate-50">
        ...
        <p className="hero-desc text-lg md:text-xl text-slate-400 max-w-2xl mx-auto mb-10 leading-relaxed">
        ...
        <div className="hero-cta flex flex-col sm:flex-row items-center justify-center gap-4">
          <Button size="lg" onClick={scrollToBooking} className="w-full sm:w-auto group">
            Agendar Revisión
