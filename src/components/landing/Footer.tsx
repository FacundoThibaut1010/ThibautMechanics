          ...
          <div className="md:col-span-2 space-y-6">
            <Link to="/" onClick={(e) => handleScroll('inicio', e)} className="flex items-center text-2xl font-black tracking-tight group">
              <img
                ...
                className="w-20 h-20 object-contain drop-shadow-[0_0_8px_rgba(220,38,38,0.4)] group-hover:drop-shadow-[0_0_12px_rgba(220,38,38,0.7)] transition-all duration-300"
              />
              <span className="ml-3 text-xl md:text-2xl font-extrabold text-white">
                Thibaut<span className="text-primary">Mechanic</span>
              </span>
            </Link>
